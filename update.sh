...
if [ "$current_version" != "$desired_version" ]; then
    ...
    pwd
     if ls *.pkg.tar.zst 1> /dev/null 2>&1; then
        ...
        send_telegram_notification "New Android Studio Version: $desired_version https://github.com/honeypie112/android-studio-alex/releases/download/$TAG_NAME/android-studio-alex-$desired_version-1-x86_64.pkg.tar.zst"
    else
